...
<section class="orders">
   ...
   <div class="box">
      ...
      <?php if ($fetch_orders['payment_status'] != 'completed') { ?>
          <p><a style="color: white; background-color: red;" href="orders.php?delete=<?= $fetch_orders['id']; ?>" onclick="return confirm('Are you sure you want to delete this order?');">Cancel Order</a></p>
      <?php } ?>
   </div>
   <?php
         }
